...
//  Project4
//
//  Created by Santiago Rguez-Arias Mtnez-Berná on 25/3/22.
//
...
class ViewController: UIViewController, WKNavigationDelegate {
    ...
    var websites = ["apple.com", "hackingwithswift.com", "apache.org"]
    ...
    override func viewDidLoad() {
        ...
        toolbarItems = [progressButton, spacer, goBack, refresh, goForward]
